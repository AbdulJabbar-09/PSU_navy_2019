...
#define map_x_hit (my_putstr(": \e[31mhit\e[0m\n\n"),      \
map[x + 1][y + 1] = 'x')

#define map_o_missed (my_putstr(": \e[31mmissed\e[0m\n\n"),        \
(map[x + 1][y + 1] != 'x') ?      \
map[x + 1][y + 1] = 'o' : 0)

#define wait_and_pause (my_putstr("\e[32mwaiting for enemy \
connection...\n\e[0m"), sfMusic_play(music), recup_player_pid(act), pause())
